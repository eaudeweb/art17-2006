# Script (Python)
# /article17/wiki/manage_wiki_comments
# params: ''
...
return RESPONSE.redirect('%s/wiki?id=%s&comm_id=%s&region=%s&species=%s&habitat=%s' % (referer, wiki_id, comment_id, region, species, habitat))

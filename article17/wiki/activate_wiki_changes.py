# Script (Python)
# /article17/wiki/activate_wiki_changes
# params: ''
...
return RESPONSE.redirect('%s/wiki/changes_html?id=%s&region=%s&species=%s&habitat=%s' % (referer, wiki_id, region, species, habitat))

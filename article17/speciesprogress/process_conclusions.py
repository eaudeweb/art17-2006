# Script (Python)
# /article17/speciesprogress/process_conclusions
...
output = {}
records = context.sql_methods.select_species_conclusions(conclusion=conclusion_type, group=group)

for record in records:
    #loading...
    species = record['assesment_speciesname']
    ...
    if not output.has_key(species):
        #initialize
        output[species] = {'ALP':{}, 'ATL':{}, 'BOR':{}, 'CON':{}, 'MAC':{}, 'MED':{}, 'PAN':{}, 'MATL':{}, 'MBAL':{}, 'MMAC':{}, 'MMED':{}}

    dict = output[species][region]

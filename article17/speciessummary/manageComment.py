# Script (Python)
# /article17/speciessummary/manageComment
# params: ''
...
return RESPONSE.redirect('%s/comments_html?region=%s&amp;species=%s&amp;user=%s&amp;ms=%s' % (context.absolute_url(), region, species, user, ms))
